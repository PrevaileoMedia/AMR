...
urlpatterns = [
    ...
    path('uprofile/', views.uprofile, name="user_profile"),
    path('sprofile/', views.sprofile, name="seller_profile"),
    path('sprofile_courses/', views.sprofile_courses, name="sprofile_courses"),
